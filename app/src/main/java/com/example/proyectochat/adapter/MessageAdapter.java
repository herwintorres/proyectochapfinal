package com.example.proyectochat.adapter;
...
public class MessageAdapter extends ArrayAdapter<MessageModel> {
    ...
    public View getView(int position, @Nullable View converView, @NonNull ViewGroup parent){
        ...
        if(listItem == null){
            listItem = LayoutInflater.from(mContext).inflate(R.layout.item_message, parent,
                            false);
        }
        ...
        //Devolver la lista completa para mostrarla en ListView
        return listItem;
    }
